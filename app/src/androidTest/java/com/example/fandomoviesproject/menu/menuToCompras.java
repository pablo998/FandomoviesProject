...
public class menuToCompras {

    @Rule
    public ActivityTestRule<MenuActivity> mActivityTestRule = new ActivityTestRule<>(MenuActivity.class);

    @Test
    public void menuToCompras() {
        ...
        ViewInteraction textView2 = onView(
                allOf(withText("Compras"),
                        withParent(allOf(withId(R.id.main_toolbar),
                                withParent(withId(R.id.appbar)))),
                        isDisplayed()));
        textView2.check(matches(withText("Compras")));

        ViewInteraction textView3 = onView(
                allOf(withId(R.id.itemBorrar), withContentDescription("Borrar"),
