...
public class menuToAyuda {

    @Rule
    public ActivityTestRule<MenuActivity> mActivityTestRule = new ActivityTestRule<>(MenuActivity.class);

    @Test
    public void menuToAyuda() {
        ...
        ViewInteraction textView2 = onView(
                allOf(withText("Ayuda"),
                        withParent(allOf(withId(R.id.main_toolbar),
                                withParent(withId(R.id.appbar)))),
                        isDisplayed()));
        textView2.check(matches(withText("Ayuda")));

        ViewInteraction textView3 = onView(
                allOf(withId(R.id.ayuda_text), withText("¿Tienes problemas con la App?\n\nNo dudes en contactar con nuestro equipo de soporte técnico indicando el problema sucedido para que lo podamos solventar lo antes posible.\n\n\nTeléfono: +34 785392927"),
